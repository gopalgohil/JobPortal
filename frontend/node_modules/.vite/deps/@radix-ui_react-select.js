...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-MAI7CSQ6.js";
import {
  createCollection,
  useDirection,
  usePrevious
} from "./chunk-X2M5KKZR.js";
import {
  Slot
} from "./chunk-4DZSFKNO.js";
import {
  require_jsx_runtime
...
function useSize(element) {
  const [size2, setSize] = React12.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React13.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React13.useState(null);
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  const Node = React16.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var RemoveScroll = React18.forwardRef(function(props, parentRef) {
  ...
  return React18.createElement(
    React18.Fragment,
    null,
    enabled && React18.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React19.useState(styleSingleton)[0];
  ...
  return React19.createElement(
    React19.Fragment,
    null,
    inert ? React19.createElement(Style, { styles: generateStyle(id) }) : null,
...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React21.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React21.useState(false);
  ...
  const triggerPointerDownPosRef = React21.useRef(null);
  const isFormControl = trigger ? Boolean(trigger.closest("form")) : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React21.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime10.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime10.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React21.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React21.useCallback((option) => {
...
var SelectTrigger = React21.forwardRef(
  (props, forwardedRef) => {
...
var SelectValue = React21.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React21.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React21.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME2, props.__scopeSelect);
    const [fragment, setFragment] = React21.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React21.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [viewport, setViewport] = React21.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React21.useState(null);
    const [selectedItemText, setSelectedItemText] = React21.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React21.useState(false);
    const firstValidItemFoundRef = React21.useRef(false);
    React21.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React21.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React21.useCallback(
    ...
    const itemRefCallback = React21.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React21.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React21.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React21.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React21.useState(null);
  const [content, setContent] = React21.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React21.useRef(false);
  const shouldRepositionRef = React21.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React21.useCallback(() => {
  ...
  const handleScrollButtonChange = React21.useCallback(
    (node) => {
...
var SelectPopperPosition = React21.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React21.useRef(0);
...
var SelectGroup = React21.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React21.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React21.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React21.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime10.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React21.useCallback((node) => {
...
var SelectItemText = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React21.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React21.useMemo(
...
var SelectItemIndicator = React21.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React21.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React21.useState(false);
...
var SelectScrollDownButton = React21.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React21.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React21.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React21.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React21.useCallback(() => {
...
var SelectSeparator = React21.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React21.forwardRef(
  (props, forwardedRef) => {
...
var BubbleSelect = React21.forwardRef(
  (props, forwardedRef) => {
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React21.useRef("");
  const timerRef = React21.useRef(0);
  const handleTypeaheadSearch = React21.useCallback(
    (key) => {
  ...
  const resetTypeahead = React21.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React21.useEffect(() => {
